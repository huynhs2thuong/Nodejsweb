  ...
  function(cb) {
    ...
    if(err == null) {
      ...
      router.post("/register", function(req, res) {
        if (accountsList.find(element => element.email == req.body.email || element.username == req.body.username) == null) {
          ...
          let transporter = nodemailer.createTransport({
            ...
            auth: {
                user: "thuongs2love@gmail.com", // generated ethereal user
                pass: "irwxomyycqycuyte" // generated ethereal password
            }
          });

          // setup email data with unicode symbols
          let mailOptions = {
              from: '"FPT shop 👻" <fptshop@gmail.com>', // sender address
      ...
      router.post('/shopping-cart/:id', function(req, res) {
        ...
        let mailOptions = {
            from: '"FPT Shop👻" <fptshop@gmail.com>', // sender address
            to: 'huynhpham.pix@gmail.com', // list of receivers
            subject: 'Mua hàng thành công', // Subject line
            text: 'Bạn đã mua hàng thành công ', // plain text body
        };
